...
const PAGE_META = {
  ...
  dashboard: {
    t: "Dashboard",
    s: "Visão geral das suas finanças pessoais"
  },
  gastos: {
    t: "Gastos",
    s: "Sua planilha completa de lançamentos"
  },
  faturas: {
    t: "Faturas",
    s: "Gestão de faturas dos seus cartões de crédito"
  },
  relatorios: {
    t: "Relatórios",
    s: "Análise da distribuição dos seus gastos"
  },
  config: {
    t: "Configurações",
    s: "Personalize sua experiência"
  }
};
...
function PetalDecor({
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", {
    className: "ariana-grain"
  }), petals.map(p => React.createElement("div", {
    key: p.id,
    className: "ariana-petal",
    style: {
      left: p.left,
      width: p.size,
      height: p.size,
  ...
  }, p.type === 0 ? React.createElement("svg", {
    viewBox: "0 0 50 50",
    width: p.size,
    height: p.size,
    fill: "none"
    ...
    fill: "white",
    opacity: "0.90"
  })) : p.type === 1 ? React.createElement("svg", {
    viewBox: "0 0 24 52",
    width: Math.round(p.size * 0.5),
    height: p.size,
    fill: "none"
  }, React.createElement("path", {
    d: "M12 2 C18 10,20 26,12 50 C4 26,6 10,12 2Z",
    fill: "white",
    opacity: "0.65"
...
function LemonSVG({
  ...
  const rOuter = sz * 0.48;
  const rRind = sz * 0.375;
  const rPith = sz * 0.305;
  const rFlesh = sz * 0.305;
  const rCore = sz * 0.062;
  const N = 8;
  const step = 360 / N;
  const gap = 2.2;
  const seg = i => {
    ...
    const x1 = cx + rFlesh * Math.cos(a1),
      y1 = cy + rFlesh * Math.sin(a1);
    const x2 = cx + rFlesh * Math.cos(a2),
      y2 = cy + rFlesh * Math.sin(a2);
    return `M ${cx} ${cy} L ${x1} ${y1} A ${rFlesh} ${rFlesh} 0 0 1 ${x2} ${y2} Z`;
  };
  const memEnd = i => {
    const a = toR(i * step - 90);
    return {
      x: cx + rFlesh * Math.cos(a),
      y: cy + rFlesh * Math.sin(a)
    };
  };
  const gid = `lsv${sz}`;
...
function AcidDecor({
  ...
  return React.createElement(React.Fragment, null, slices.map(s => React.createElement("div", {
    key: s.id,
    className: "lemon-slice",
    style: {
      left: s.left,
      "--ls-op": s.op,
      "--ls-r1": s.r1,
...
function SweetDecor({
  ...
  const pick = dist => {
    for (let i = 0; i < 100; i++) {
      const t = r(4, 90),
        l = r(4, 90);
      if (occupied.current.every(p => Math.hypot(p.t - t, p.l - l) > dist)) return {
        t,
        l
      };
    }
  ...
  const free = (t, l) => {
    occupied.current = occupied.current.filter(p => Math.hypot(p.t - t, p.l - l) > 0.15);
  };
  useEffect(() => {
    if (theme !== "sweet") {
      setSparkles([]);
  ...
  return React.createElement(React.Fragment, null, sparkles.map(s => React.createElement("div", {
    key: s.id,
    ...
    d: "M12 3 L12.8 11.2 L21 12 L12.8 12.8 L12 21 L11.2 12.8 L3 12 L11.2 11.2 Z",
    fill: "#FFF2B8",
    opacity: "0.7"
  })))), kisses.map(k => React.createElement("div", {
    key: k.id,
    className: "sweet-kiss-wrap",
    style: {
      top: k.top,
      left: k.left,
    ...
    d: "M2 13 Q3 4, 12 3 Q16 0, 20 5 Q24 0, 28 3 Q37 4, 38 13 Q36 23, 28 27 Q24 30, 20 27 Q16 30, 12 27 Q4 23, 2 13Z",
    fill: "rgba(218,72,98,0.85)"
  }), React.createElement("path", {
    d: "M8 13 Q13 8, 20 13 Q27 8, 32 13 Q27 20, 20 20 Q13 20, 8 13Z",
    fill: "rgba(168,38,62,0.72)"
  }), React.createElement("ellipse", {
    cx: "14",
    cy: "8.5",
    rx: "4.5",
    ry: "2.2",
    fill: "rgba(255,195,205,0.50)"
  }), React.createElement("ellipse", {
    cx: "26",
    cy: "8",
    rx: "2.8",
    ry: "1.6",
    fill: "rgba(255,195,205,0.35)"
  }))))));
}
function FancyCharmSVG({
  type,
  sz
}) {
  if (type === 0) {
    return React.createElement("svg", {
      ...
      d: "M2 14 L2 6 L9 12 L14 2 L19 12 L26 6 L26 14 Z",
      fill: "#C03A52",
      opacity: "0.80"
    }), React.createElement("circle", {
      cx: "14",
      cy: "5",
      r: "1.8",
      fill: "rgba(255,215,220,0.88)"
    }), React.createElement("circle", {
      cx: "7",
      cy: "11",
      r: "1.2",
      fill: "rgba(255,215,220,0.78)"
    }), React.createElement("circle", {
      cx: "21",
      cy: "11",
      r: "1.2",
  ...
  if (type === 1) {
    ...
    return React.createElement("svg", {
      ...
      viewBox: "0 0 30 30",
      fill: "none"
    }, petals.map((a, i) => React.createElement("ellipse", {
      key: i,
      cx: "15",
      cy: "6",
      rx: "3.2",
  ...
  if (type === 2) {
    return React.createElement("svg", {
      ...
      height: "19",
      rx: "1",
      fill: "rgba(155,108,125,0.35)"
    }), React.createElement("circle", {
      cx: "5",
      cy: "5",
      r: "1.2",
      fill: "rgba(192,80,108,0.45)"
    }), React.createElement("circle", {
      cx: "21",
      cy: "5",
      r: "0.9",
      fill: "rgba(192,80,108,0.38)"
    }), React.createElement("rect", {
      x: "7",
      y: "24.5",
      width: "12",
  ...
  if (type === 3) {
    return React.createElement("svg", {
      ...
      d: "M17 10 L4 2 Q1 4 2 6.5 L15 12 Z",
      fill: "#9B3040",
      opacity: "0.78"
    }), React.createElement("path", {
      d: "M17 10 L4 18 Q1 16 2 13.5 L15 8 Z",
      fill: "#7A2030",
      opacity: "0.70"
    }), React.createElement("path", {
      d: "M17 10 L30 2 Q33 4 32 6.5 L19 12 Z",
      fill: "#9B3040",
      opacity: "0.78"
    }), React.createElement("path", {
      d: "M17 10 L30 18 Q33 16 32 13.5 L19 8 Z",
      fill: "#7A2030",
      opacity: "0.70"
    }), React.createElement("line", {
      x1: "4",
...
function FancyDecor({
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", {
    className: "fancy-grain"
  }), charms.map(c => React.createElement("div", {
    key: c.id,
    className: "fancy-charm",
    style: {
      left: c.left,
      bottom: `-${c.sz + 20}px`,
      "--fc-op": c.op,
  ...
  }, React.createElement(FancyCharmSVG, {
    type: c.type,
    sz: c.sz
  }))));
}
function ChromeDecor({
  theme
}) {
  ...
  })), sparks.map(s => React.createElement("div", {
    key: s.id,
    className: "chrome-spark",
    style: {
      top: s.top,
      left: s.left,
      width: s.s,
...
function App() {
  ...
  const [profile, setProfile] = useState(() => {
    try {
      ...
      if (s) {
        ...
        if (p.theme === "ariana") p.theme = "petal";
        return p;
      }
    } catch (e) {}
    return null;
  ...
  const addCustomCat = cat => {
    ...
    try {
      localStorage.setItem(LS_CATS, JSON.stringify(updated));
    } catch (e) {}
  };
  ...
  const markFaturaPaid = (cardId, mes) => {
    ...
    try {
      localStorage.setItem(LS_FAT, JSON.stringify(updated));
    } catch (e) {}
  ...
  const [fixas, setFixas] = useState(() => {
    try {
      const s = localStorage.getItem(LS_FIXAS);
      if (s) return JSON.parse(s);
    } catch (e) {}
    return [];
  });
  const addFixa = f => {
    ...
    setFixas(u);
    try {
      localStorage.setItem(LS_FIXAS, JSON.stringify(u));
    } catch (e) {}
    showToast("Conta fixa adicionada");
  };
  const deleteFixa = id => {
    const u = fixas.filter(f => f.id !== id);
    setFixas(u);
    try {
      localStorage.setItem(LS_FIXAS, JSON.stringify(u));
    } catch (e) {}
    showToast("Removida", "trash");
  };
  const [caloteiros, setCaloteiros] = useState(() => {
    try {
      const s = localStorage.getItem(LS_CALOTEIROS);
      if (s) return JSON.parse(s);
    } catch (e) {}
    return [];
  });
  const addCaloteiro = c => {
    const u = [...caloteiros, {
      ...c,
      id: uid(),
      pago: false,
    ...
    setCaloteiros(u);
    try {
      localStorage.setItem(LS_CALOTEIROS, JSON.stringify(u));
    } catch (e) {}
    showToast("Devedor adicionado");
  };
  const deleteCaloteiro = id => {
    const u = caloteiros.filter(c => c.id !== id);
    setCaloteiros(u);
    try {
      localStorage.setItem(LS_CALOTEIROS, JSON.stringify(u));
    } catch (e) {}
  ...
  const toggleCaloteiro = id => {
    const u = caloteiros.map(c => {
      ...
      if (parcelas > 1) {
        ...
        return {
          ...c,
          parcPaga: newParcPaga,
          pago: newParcPaga >= parcelas
        };
      }
      return {
        ...c,
  ...
  const [emprestimos, setEmprestimos] = useState(() => {
    try {
      const s = localStorage.getItem(LS_EMPRESTIMOS);
      if (s) return JSON.parse(s);
    } catch (e) {}
    return [];
  });
  const addEmprestimo = e => {
    const u = [...emprestimos, {
      ...e,
      id: uid()
    }];
    setEmprestimos(u);
    try {
      localStorage.setItem(LS_EMPRESTIMOS, JSON.stringify(u));
    } catch (e) {}
    showToast("Empréstimo adicionado");
  };
  const deleteEmprestimo = id => {
    const u = emprestimos.filter(e => e.id !== id);
    setEmprestimos(u);
    try {
      localStorage.setItem(LS_EMPRESTIMOS, JSON.stringify(u));
    } catch (e) {}
  ...
  const updateEmprestimo = (id, changes) => {
    const u = emprestimos.map(e => e.id === id ? {
      ...e,
      ...changes
    } : e);
    setEmprestimos(u);
  ...
  const addCard = card => {
    ...
    setCards(updated);
    try {
      localStorage.setItem(LS_CARDS, JSON.stringify(updated));
    } catch (e) {}
  };
  const deleteCard = id => {
  ...
  const saveTransaction = exp => {
    ...
    if (!isEditing && exp.kind === "gasto" && exp.forma === "parcelado" && exp.parcTotal > 1) {
      ...
      const parcList = Array.from({
        length: exp.parcTotal
      }, (_, i) => {
  ...
  const submitQuick = () => {
    ...
    if (!parsed) {
      showToast("Não entendi — tente: \"Gastei R$50 com comida\"");
      return;
    }
    if (parsed.kind !== "entrada" && !settings.autoCat) parsed.categoria = "outros";
    setExpenses(prev => [parsed, ...prev]);
    setQuick("");
    showToast(parsed.kind === "entrada" ? `+${fmtBRL(parsed.valor)} entrada adicionada` : `+${fmtBRL(parsed.valor)} · ${CAT_MAP[parsed.categoria]?.nome || parsed.categoria}`);
  };
  const resetData = () => {
  ...
  const restoreBackup = data => {
    ...
    if (data.cards) {
      setCards(data.cards);
      try {
        localStorage.setItem(LS_CARDS, JSON.stringify(data.cards));
      } catch (e) {}
    }
    if (data.fixas) {
      setFixas(data.fixas);
      try {
        localStorage.setItem(LS_FIXAS, JSON.stringify(data.fixas));
      } catch (e) {}
    }
    if (data.caloteiros) {
      setCaloteiros(data.caloteiros);
      try {
        localStorage.setItem(LS_CALOTEIROS, JSON.stringify(data.caloteiros));
      } catch (e) {}
    }
    if (data.emprestimos) {
      setEmprestimos(data.emprestimos);
      try {
        localStorage.setItem(LS_EMPRESTIMOS, JSON.stringify(data.emprestimos));
      } catch (e) {}
    }
  ...
  return React.createElement("div", {
    ...
    className: "brand-sub"
  }, "Controle de gastos"))), React.createElement("nav", {
    className: "nav"
  }, React.createElement("div", {
    className: "nav-label"
  }, "Menu"), NAV.map(n => {
    ...
    className: "avatar"
  }, userName.slice(0, 2).toUpperCase()), React.createElement("div", {
    style: {
      minWidth: 0
    }
  }, React.createElement("div", {
  ...
  }, userName))))), React.createElement("main", {
  ...
  }, meta.t), meta.s && React.createElement("div", {
    className: "page-sub"
  }, meta.s))), page === "home" && React.createElement(HomeView, {
    expenses: expenses,
    ...
    onGoToConfig: () => {
      setGastosInitialTab("fixas");
      setPage("gastos");
    }
  }), page === "dashboard" && React.createElement(DashboardView, {
    expenses: expenses,
    filtered: filtered,
    byCat: byCat,
    total: total,
    ...
    onUpdateEmprestimo: updateEmprestimo,
    fixas: fixas,
    onAddFixa: addFixa,
    onDeleteFixa: deleteFixa,
    caloteiros: caloteiros,
    onAddCaloteiro: addCaloteiro,
    onToggleCaloteiro: toggleCaloteiro,
    onDeleteCaloteiro: deleteCaloteiro,
    onAddCard: addCard,
    ...
    search,
    setSearch
  }), page === "faturas" && React.createElement(FaturasView, {
    cards: cards,
    expenses: expenses,
    faturaOverrides: faturaOverrides,
    onMarkPaid: markFaturaPaid,
  ...
  }), modal !== null && React.createElement(ExpenseModal, {
    initKind: modal?.kind || "gasto",
    initial: modal && modal.id ? modal : null,
    onSave: saveTransaction,
    onClose: () => setModal(null),
    allCats: allCats,
    cards: cards
  }), React.createElement(PetalDecor, {
    theme: profile?.theme
  }), React.createElement(AcidDecor, {
    theme: profile?.theme
  }), React.createElement(ChromeDecor, {
    theme: profile?.theme
